...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code oapRefreshIndices}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOapRefreshIndices(SqlBaseParser.OapRefreshIndicesContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code oapCreateIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOapCreateIndex(SqlBaseParser.OapCreateIndexContext ctx);
	/**
	 * Visit a parse tree produced by the {@code oapDropIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOapDropIndex(SqlBaseParser.OapDropIndexContext ctx);
	/**
	 * Visit a parse tree produced by the {@code oapShowIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOapShowIndex(SqlBaseParser.OapShowIndexContext ctx);
	/**
	 * Visit a parse tree produced by the {@code oapCheckIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOapCheckIndex(SqlBaseParser.OapCheckIndexContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#indexType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIndexType(SqlBaseParser.IndexTypeContext ctx);
	/**
